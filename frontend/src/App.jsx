...
import { Sparkles, Video, Image, Loader2, Download, RefreshCw, Wand2, Film, Zap, Info, X } from 'lucide-react';
import './App.css';
    ...
    <div className="app">
      ...
      <header className="header">
        <div className="header-content">
          ...
          <p className="tagline">Create stunning AI images & videos</p>
        </div>
      </header>
      ...
      <main className="main">
        ...
        <section className="generator-panel">
          ...
          {showEnhancement && enhancement && (
            <div className="enhancement-panel">
              <div className="enhancement-header">
                ...
                <button className="close-btn" onClick={() => setShowEnhancement(false)}>
                  <X size={16} />
                </button>
              </div>
                  ...
                  <div className="suggestions">
                    ...
                    <ul>
                      {enhancement.suggestions.map((s, i) => (
                        <li key={i}><Info size={14} /> {s}</li>
                      ))}
                    </ul>
                  </div>
                )}
                <button className="apply-btn" onClick={applyEnhancement}>
          ...
          <button 
            ...
            disabled={loading || !prompt.trim() || videoStatus === 'processing'}
          >
            {loading ? (
              <>
          ...
          {result ? (
            <div className="result-content">
              ...
              {result.type === 'image' ? (
                <div className="result-image-container">
                  <img src={result.data.url} alt={result.data.prompt} />
                </div>
              ) : (
              ...
              <div className="result-actions">
                <a href={result.data.url} download className="action-btn">
                  <Download size={18} />
                  <span>Download</span>
                </a>
              ...
              {result.data.model && (
                <p className="result-model">Created with {result.data.model}</p>
              )}
            </div>
          ) : videoStatus === 'processing' ? (
            ...
            <div className="empty-state">
              <div className="empty-icon">
                {activeTab === 'image' ? <Image size={64} /> : <Video size={64} />}
              </div>
